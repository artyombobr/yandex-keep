...
router.route('/').get(notesControllers_1.getNotes).post(notesControllers_1.addNote);
router.route('/:id').delete(notesControllers_1.deleteNote).patch(notesControllers_1.editNote);
